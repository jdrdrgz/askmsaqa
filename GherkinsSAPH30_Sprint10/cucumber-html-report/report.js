$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("ViewBookingPage.feature");
formatter.feature({
  "line": 1,
  "name": "VIP Booking",
  "description": "",
...
formatter.scenario({
  "line": 3,
  "name": "VIP Booking - View Booking Page",
  "description": "",
  "id": "vip-booking;vip-booking---view-booking-page",
  "type": "scenario",
  "keyword": "Scenario"
});
formatter.step({
...
formatter.step({
  "line": 9,
  "name": "Click Course Bookings dropdown",
  "keyword": "Then "
});
formatter.step({
  "line": 10,
...
formatter.step({
  "line": 11,
  "name": "Verify that Course Bookings Page is displayed",
  "keyword": "Then "
});
formatter.step({
  "line": 12,
  "name": "Verify that Course Bookings header is displayed",
  "keyword": "Then "
});
formatter.step({
  "line": 13,
  "name": "Verify that Course Bookings header text is correct",
  "keyword": "Then "
});
formatter.step({
  "line": 14,
  "name": "Verify that Book a Course button is displayed",
  "keyword": "Then "
});
formatter.step({
  "line": 15,
  "name": "Verify that Show Entries option is displayed",
  "keyword": "Then "
});
formatter.step({
  "line": 16,
  "name": "Verify that Search field is displayed",
  "keyword": "Then "
});
formatter.step({
  "line": 17,
  "name": "Verify that Bookings table is displayed",
  "keyword": "Then "
});
formatter.step({
  "line": 18,
  "name": "Verify that Date Booked Column is present",
  "keyword": "Then "
});
formatter.step({
  "line": 19,
  "name": "Verify that Course Name Column is present",
  "keyword": "Then "
});
formatter.step({
  "line": 20,
  "name": "Verify that Location Column is present",
  "keyword": "Then "
});
formatter.step({
  "line": 21,
  "name": "Verify that Schedule Column is present",
  "keyword": "Then "
});
formatter.step({
  "line": 22,
  "name": "Verify that Status Column is present",
  "keyword": "Then "
});
formatter.step({
  "line": 23,
  "name": "Verify that Actions Column is present",
  "keyword": "Then "
});
formatter.step({
  "line": 24,
  "name": "Verify that pagination is present",
  "keyword": "Then "
});
formatter.step({
  "line": 25,
  "name": "Verify that the Number of entries shown label is present",
  "keyword": "Then "
});
formatter.step({
  "line": 26,
  "name": "Verify that Edit button is present",
  "keyword": "Then "
});
formatter.step({
  "line": 27,
  "name": "Verify that Details Button is present",
  "keyword": "Then "
});
formatter.step({
  "line": 28,
