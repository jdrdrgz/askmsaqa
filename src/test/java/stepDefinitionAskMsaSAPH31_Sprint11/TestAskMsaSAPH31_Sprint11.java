package stepDefinitionAskMsaSAPH31_Sprint11;
...
public class TestAskMsaSAPH31_Sprint11 {
	...
	public void select_another_Employee_with_registered_email_address_and_click_Add_to_List_button() throws Throwable {
		Thread.sleep(1000);
		Actions actions = new Actions(driver);
  		actions.moveToElement(driver.findElement(By.id(config.getBookingEmployeesDdl())));
  		actions.click();
	...
	public void tick_Email_Booking_Details_checkbox_if_available() throws Throwable {
		 ...
		 driver.findElement(By.id(config.getTickBookingEmpOther())).click();
	}
