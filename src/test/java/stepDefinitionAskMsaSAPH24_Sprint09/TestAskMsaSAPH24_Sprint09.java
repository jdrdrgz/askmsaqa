package stepDefinitionAskMsaSAPH24_Sprint09;
...
public class TestAskMsaSAPH24_Sprint09 {
	...
	public void verify_that_Ship_was_added_successfully_message_is_displayed() throws Throwable {
		String expectedAddShipsMessage = config.getAddShipSuccessMsg();
	    String actualAddShipsMessage = driver.findElement(By.id(config.getAddShipSuccessMsgActual())).getText();
	    
	    Assert.assertEquals(expectedAddShipsMessage, actualAddShipsMessage);
	...
	public void verify_that_Ship_is_added_in_the_table() throws Throwable {
